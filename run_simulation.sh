...
echo "2) Sensitivity Test - 175cm Extended Line Source"
...
1)
  ...
  ;;
2)
  PHANTOM="mac/phantom_sensitivity_175cm.mac"
  SOURCE="mac/source_sensitivity_175cm.mac"
  TEST_NAME="Sensitivity_175cm"
  echo -e "${YELLOW}Selected: 175cm Extended Sensitivity Test${NC}"
  ;;
3)
  PHANTOM="mac/phantom_scatter_70cm.mac"
  SOURCE="mac/source_scatter_70cm.mac"
  TEST_NAME="Count_Rate_70cm"
  echo -e "${YELLOW}Selected: 70cm Count Rate Test${NC}"
  ;;
4)
  PHANTOM="mac/phantom_scatter_175cm.mac"
  SOURCE="mac/source_scatter_175cm.mac"
